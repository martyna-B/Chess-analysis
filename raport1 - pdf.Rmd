...
### Warunkowanie różcią rankigu białego i czarnego gracza

Analizowaliśmy jak wyglądają prawdopodobieństwa zakończenia parti od rankingu białego, ale rankig czanrego powinnien mieć też wpływ więc Dodatmy nową kolumnę, która będzie oznaczać różnice między rankingiem białego i czarnego. Różnice w rankingu ponieważ są ciągłe więc też podzielimy je na kategorię tak jak dla rankingu białego. Rozkład różnic w rankigu wygląda następująco:
```{r}
