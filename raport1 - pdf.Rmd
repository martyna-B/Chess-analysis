...
Celem analizy będzie odpowiedzenie na pytanie - jakie jest prawdopodobieństwo różnych zakończeń gry: wygranej białego gracza, czarnego lub remisu? Będziemy rozważać ten problem pod kątem rozegranego otwarcia, rankingu graczy, różnicy w$~$rankingu między graczem białym i$~$czarnym oraz liczby tur w$~$partii. Użyjemy metody bootstrap do stworzenia przedziałów ufności estymowanego prawdopodobieńśtwa. 
...
```
Wygenerowane histogramy sugerują, że rozkład rankingu białego i czarnego gracza są bardzo podobne. Rodzi się pytanie, jak wyglądaja ich średnia, mediana,  wariancja, skośność czy kurtoza.
```{r, include=FALSE}
